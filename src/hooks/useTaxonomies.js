 ...
 *
 * @param {string} taxonomy Taxonomy slug to query. Default: '{{namespace}}_category'.
 ...
 *
 * @example
 * const { terms, isLoading } = useTaxonomies('{{namespace}}_category', {
 *   hide_empty: true,
 *   per_page: 50,
 * });
 *
